...
const struct cmd_tbl_entry np_cmdtable[]=
{
	{ "spconn02fxt", "spconn02fxt", "Connect to Subaru ECU (~2002 Forester XT) with current parameters",
	  cmd_spconn02fxt, 0, NULL},
	...
	{ "kspeed", "kspeed <new_speed>", "Change kernel comms speed and reinitialize kernel; Recommended <new_speed> values: 62500, 31250, 25000.",
	  cmd_kspeed, 0, NULL},
	{ "sprunk02fxt", "sprunk02fxt <file>", "Send + run specified kernel [Subaru Forester ~2002 FXT]",
	  cmd_sprunk02fxt, 0, NULL},
